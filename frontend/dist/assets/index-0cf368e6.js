      ...
      j &&
        (sp &&
          ...
          (Dr || j !== "onCompositionStart"
            ? j === "onCompositionEnd" && Dr && (_ = ip())
            : ((An = c),
              (wu = "value" in An ? An.value : An.textContent),
              (Dr = !0))),
        (T = ii(u, j)),
        0 < T.length &&
          ((j = new Ac(j, e, null, n, c)),
          h.push({ event: j, listeners: T }),
          _ ? (j.data = _) : ((_ = up(n)), _ !== null && (j.data = _)))),
        (_ = qv ? Jv(e, n) : ey(e, n)) &&
...
function Op(e) {
  ...
  function w(f, d, v, p) {
    for (
      var k = null, T = null, _ = d, j = (d = 0), U = null;
      _ !== null && j < v.length;
      j++
    ) {
    ...
    if (j === v.length) return n(f, _), xe && or(f, j), k;
    if (_ === null) {
      for (; j < v.length; j++)
        (_ = h(f, v[j], p)),
          _ !== null &&
            ((d = l(_, d, j)), T === null ? (k = _) : (T.sibling = _), (T = _));
      return xe && or(f, j), k;
    }
    for (_ = r(f, _); j < v.length; j++)
      (U = y(_, f, j, v[j], p)),
        U !== null &&
  ...
  function g(f, d, v, p) {
    ...
    for (
      var T = (k = null), _ = d, j = (d = 0), U = null, z = v.next();
      _ !== null && !z.done;
      j++, z = v.next()
    ) {
      _.index > j ? ((U = _), (_ = null)) : (U = _.sibling);
    ...
    if (z.done) return n(f, _), xe && or(f, j), k;
    if (_ === null) {
      for (; !z.done; j++, z = v.next())
        (z = h(f, z.value, p)),
          z !== null &&
            ((d = l(z, d, j)), T === null ? (k = z) : (T.sibling = z), (T = z));
      return xe && or(f, j), k;
    }
    for (_ = r(f, _); !z.done; j++, z = v.next())
      (z = y(_, f, j, z.value, p)),
        z !== null &&
...
function k0(e) {
  ...
  function ee(E, R) {
    ...
    u.v7_fetcherPersist &&
      p.fetchers.forEach((V, N) => {
        V.state === "idle" && (se.has(N) ? M.push(N) : P.push(N));
      }),
      h.forEach((V) =>
  ...
  async function Ot(E, R, P) {
    ...
    let A = jo(e.history, R, _.signal, P && P.submission),
      W,
      H;
    if (P && P.pendingError) H = { [Vo(N).route.id]: P.pendingError };
    else if (P && P.submission && Ft(P.submission.formMethod)) {
      let G = await tt(A, R, P.submission, N, { replace: P.replace });
  ...
  async function tt(E, R, P, M, V) {
    ...
    if (Zr(A)) {
      ...
      return (
        ...
        await Mt(p, A, { submission: P, replace: H }),
        { shortCircuited: !0 }
      );
    }
    if (Wo(A)) {
  ...
  async function Rr(E, R, P, M, V, N, A, W, H) {
    let L = M || Zs(R, V),
      I = V || N || Hf(L),
      $ = s || i,
      [G, re] = Af(e.history, p, P, I, R, q, pe, le, F, b, $, a, W, H);
    if (
      (jn(
        (ue) =>
          !(P && P.some((te) => te.route.id === ue)) ||
    ...
    let { loaderData: ut, errors: _r } = Uf(p, P, G, Le, H, re, Ye, K);
    K.forEach((ue, te) => {
      ue.subscribe((Fe) => {
  ...
  async function ye(E, R, P, M, V, N) {
    if ((ln(), F.delete(E), !M.route.action && !M.route.lazy)) {
      let ge = kt(405, { method: N.formMethod, pathname: P, routeId: R });
      Qt(E, R, ge);
      return;
    }
  ...
  async function tr(E, R, P, M, V, N) {
    let A = p.fetchers.get(E),
      W = No(N, A ? A.data : void 0);
    p.fetchers.set(E, W), ee({ fetchers: new Map(p.fetchers) });
    let H = new AbortController(),
      L = jo(e.history, P, H.signal);
    Z.set(E, H);
    let I = ce,
  ...
  function Ee(E) {
    ...
    if (
      ...
      A({ currentLocation: R, nextLocation: P, historyAction: M })
    )
      return N;
  }
  function jn(E) {
...
function p1(e) {
  let { fallbackElement: t, router: n, future: r } = e,
    ...
    v = x.useCallback(
      (_, j) => {
        let { deletedFetchers: U, unstable_viewTransitionOpts: z } = j;
      ...
      e === void 0 && (e = {}),
      {
        ...
        async fn(t) {
          ...
          if (
            ...
            if (pe)
              return {
                data: { index: q, overflows: j },
                reset: { placement: pe },
              };
            let le =
              (z = j
                .filter((Z) => Z.overflows[0] <= 0)
                .sort((Z, ce) => Z.overflows[1] - ce.overflows[1])[0]) == null
                ? void 0
                : z.placement;
            if (!le)
              switch (y) {
...
const Mw = ({
    ...
    !j && sn && Object.assign(Pn, { mouseleave: !1, blur: !1 });
    const Qe = U
      ? { ...U }
      : {
          escape: p || !1,
...
function gm({ spot: e }) {
  ...
  return S.jsxs("div", {
    ...
    children: [
      ...
      S.jsx("img", {
        src: i === "no preview" ? "/noPreviewImg.png" : i,
        alt: "Preview Image",
      }),
      S.jsxs("div", {
...
function Kw() {
  ...
  return (
    ...
    S.jsx("div", {
      id: "view-all-spots",
      children: n.map((r, o) => S.jsx(gm, { spot: r }, o)),
    })
  );
}
...
function rS() {
  ...
  const {
    ...
    d = Object.values(g || {}),
    v =
      ((_ = d.find((j) => j.preview === !0)) == null ? void 0 : _.url) ||
      "/noPreviewImg.png",
    p = d.filter((j) => j.preview === !1) || [];
  for (; p.length < 4; ) p.push({ url: "/noMedia.png", id: `demo${p.length}` });
  function k({ Owner: j, reviewsArr: U, user: z }) {
    const Q = {};
    return (
      z &&
        (j == null ? void 0 : j.id) !== (z == null ? void 0 : z.id) &&
        (U.find(
          (q) =>
    ...
    S.jsxs("div", {
      ...
      children: [
        ...
        S.jsxs("div", {
          id: "images",
          children: [
            S.jsx("img", { id: "preview", src: v, alt: "Preview Image" }),
            S.jsx("div", {
              id: "sideImages",
              children: p.map((j) =>
                S.jsx(
                  "img",
                  { className: "sideImages", src: j.url, alt: "Spot Image" },
                  j.id,
                ),
              ),
            }),
